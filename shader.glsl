...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    // IMPORTANT
    // Raising smoothstep to a power decreases/increases intensity of light with regards to distance.

    lightAmount *= 1 - pow(smoothstep(0.0, lightSize, distanceToLight), 0.1);
